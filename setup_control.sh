...
runuser -u JC981219 -- ssh-keygen -q -t rsa -f /users/JC981219/.ssh/id_rsa -N ''
runuser -u JC981219 -- cat /users/JC981219/.ssh/id_rsa.pub >> /users/lngo/.ssh/authorized_keys

# setup NFS for key sharing
apt update
apt install -y nfs-kernel-server
mkdir /var/nfs/keys -p
cp /users/JC981219/.ssh/id_rsa* /var/nfs/keys
